...
class PayrollDocumentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'earnings' => PayrollDocumentEarningResource::collection($this->whenLoaded('earnings')),
            'deductions' => PayrollDocumentDeductionResource::collection($this->whenLoaded('deductions')),

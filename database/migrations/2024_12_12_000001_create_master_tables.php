...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('operation_types', function (Blueprint $table) {
            ...
            $table->string('code')->unique()->comment('Código DIAN');
            $table->text('description')->nullable();
            $table->string('prefix')->nullable()->comment('Prefijo para documentos');
        ...
        Schema::create('payment_means', function (Blueprint $table) {
            ...
            $table->string('payment_method_description', 255)->nullable();
        ...
        Schema::create('event_types', function (Blueprint $table) {
            ...
            $table->string('code')->unique()->comment('Código DIAN');
            $table->text('description')->nullable();
            $table->string('group')->comment('Agrupación del evento');
            $table->boolean('is_active')->default(true);
            $table->timestamps();
        });
    }
